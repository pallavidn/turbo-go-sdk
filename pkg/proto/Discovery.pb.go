...
const (
	...
	//
	// Deprecated: Marked as deprecated in Discovery.proto.
...
type TargetLinkInfoDTO_TargetLinkType int32

const (
	// Derived target discovery response can include local ID references to parent EntityDTOs.
	TargetLinkInfoDTO_PARENT_REFERENCED_BY_DERIVED TargetLinkInfoDTO_TargetLinkType = 1
	// Parent target discovery response can include local ID references to derived EntityDTOs.
	TargetLinkInfoDTO_DERIVED_REFERENCED_BY_PARENT TargetLinkInfoDTO_TargetLinkType = 2
	// Both parent and derived targets can have local references to each other.
	TargetLinkInfoDTO_BIDIRECTIONAL TargetLinkInfoDTO_TargetLinkType = 3
)

// Enum value maps for TargetLinkInfoDTO_TargetLinkType.
var (
	TargetLinkInfoDTO_TargetLinkType_name = map[int32]string{
		1: "PARENT_REFERENCED_BY_DERIVED",
		2: "DERIVED_REFERENCED_BY_PARENT",
		3: "BIDIRECTIONAL",
	}
	TargetLinkInfoDTO_TargetLinkType_value = map[string]int32{
		"PARENT_REFERENCED_BY_DERIVED": 1,
		"DERIVED_REFERENCED_BY_PARENT": 2,
		"BIDIRECTIONAL":                3,
	}
)

func (x TargetLinkInfoDTO_TargetLinkType) Enum() *TargetLinkInfoDTO_TargetLinkType {
	p := new(TargetLinkInfoDTO_TargetLinkType)
	*p = x
	return p
}

func (x TargetLinkInfoDTO_TargetLinkType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TargetLinkInfoDTO_TargetLinkType) Descriptor() protoreflect.EnumDescriptor {
	return file_Discovery_proto_enumTypes[6].Descriptor()
}

func (TargetLinkInfoDTO_TargetLinkType) Type() protoreflect.EnumType {
	return &file_Discovery_proto_enumTypes[6]
}

func (x TargetLinkInfoDTO_TargetLinkType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *TargetLinkInfoDTO_TargetLinkType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = TargetLinkInfoDTO_TargetLinkType(num)
	return nil
}

// Deprecated: Use TargetLinkInfoDTO_TargetLinkType.Descriptor instead.
func (TargetLinkInfoDTO_TargetLinkType) EnumDescriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{9, 0}
}
...
type DiscoveryResponse struct {
	...
	// Identifying properties for entities that may not have a corresponding EntityDTO instance created. Probes may send
	// this to generate an OID for the identifying property values. This use case can arise when the probe does not have
	// the capability to create an EntityDTO in the entirety, but requires an OID to store other data related to the
	// entity, for e.g. billed costs.
	EntityIdentifyingPropertyValues []*EntityIdentifyingPropertyValues `protobuf:"bytes,19,rep,name=entity_identifying_property_values,json=entityIdentifyingPropertyValues" json:"entity_identifying_property_values,omitempty"`
	// Entity level cloud commitment data. This data forms the basis of entity commitment coverage and
	// commitment utilization calculations and drive commitment based analysis.
	CloudCommitmentData []*CloudCommitmentData `protobuf:"bytes,20,rep,name=cloud_commitment_data,json=cloudCommitmentData" json:"cloud_commitment_data,omitempty"`
	// Action policies provides data about entity types and actions that can be applied to them for
	// this target. The difference between this action policy and the one defined in ProbeInfo is
	// that the latter specifies default action policies on a probe level which do not change
	// across all targets of the same probe type, whereas action policies defined here are on a
	// target level, which should be different than the default values.
	// For example, for Kubernetes probe type, the provision and suspend of a node is recommend
	// only by default because most Kubernetes clusters cannot execute node suspend and provision
	// actions. But for some Kubernetes clusters where MachineSet API is enabled, node provision
	// and suspend action can be executed as a part of cluster scaling operation.
	// Also, this action policy is set in the discovery response instead of ProbeTargetInfo is
	// because it can change anytime, so we must discover it continuously.
	ActionPolicies []*ActionPolicyDTO `protobuf:"bytes,21,rep,name=action_policies,json=actionPolicies" json:"action_policies,omitempty"`
}
...
func (x *DiscoveryResponse) GetEntityIdentifyingPropertyValues() []*EntityIdentifyingPropertyValues {
	if x != nil {
		return x.EntityIdentifyingPropertyValues
	}
	return nil
}

func (x *DiscoveryResponse) GetCloudCommitmentData() []*CloudCommitmentData {
	if x != nil {
...
func (x *DiscoveryResponse) GetActionPolicies() []*ActionPolicyDTO {
	if x != nil {
...
type ProbeStageDetails struct {
	...
	// A stage can have substages that can be described with tyhe dsame structure.
	// It is up to each probe how the substages are assembled to give the parent stage status.
	SubStages []*ProbeStageDetails `protobuf:"bytes,5,rep,name=subStages" json:"subStages,omitempty"`
	// Specifies if a stage is optional or mandatory
	IsOptional *bool `protobuf:"varint,6,opt,name=isOptional,def=0" json:"isOptional,omitempty"`
}

// Default values for ProbeStageDetails fields.
const (
	Default_ProbeStageDetails_IsOptional = bool(false)
)
...
func (x *ProbeStageDetails) GetSubStages() []*ProbeStageDetails {
	if x != nil {
		return x.SubStages
	}
	return nil
...
func (x *ProbeStageDetails) GetIsOptional() bool {
	if x != nil && x.IsOptional != nil {
		return *x.IsOptional
	}
	return Default_ProbeStageDetails_IsOptional
}
...
type TargetLinkInfoDTO struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	LinkType *TargetLinkInfoDTO_TargetLinkType `protobuf:"varint,1,opt,name=link_type,json=linkType,enum=common_dto.TargetLinkInfoDTO_TargetLinkType" json:"link_type,omitempty"`
}

func (x *TargetLinkInfoDTO) Reset() {
	*x = TargetLinkInfoDTO{}
	if protoimpl.UnsafeEnabled {
...
func (x *TargetLinkInfoDTO) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetLinkInfoDTO) ProtoMessage() {}

func (x *TargetLinkInfoDTO) ProtoReflect() protoreflect.Message {
	mi := &file_Discovery_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetLinkInfoDTO.ProtoReflect.Descriptor instead.
func (*TargetLinkInfoDTO) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{9}
}

func (x *TargetLinkInfoDTO) GetLinkType() TargetLinkInfoDTO_TargetLinkType {
	if x != nil && x.LinkType != nil {
		return *x.LinkType
	}
	return TargetLinkInfoDTO_PARENT_REFERENCED_BY_DERIVED
}
...
type DerivedTargetSpecificationDTO struct {
	...
	// Indicates whether this derived target should be linked to the parent target. Linking will indicate
	// whether EntityDTO references across the linked targets can be resolved in the topology processor.
	// References across targets will be resolved through the topology stitching graph using local IDs. Therefore,
	// linking is meant to be utilized by a group of closely related targets, in which local IDs can be determined
	// across targets.
	TargetLinkInfo *TargetLinkInfoDTO `protobuf:"bytes,6,opt,name=target_link_info,json=targetLinkInfo" json:"target_link_info,omitempty"`
}
...
func (x *DerivedTargetSpecificationDTO) GetTargetLinkInfo() *TargetLinkInfoDTO {
	if x != nil {
		return x.TargetLinkInfo
	}
	return nil
}
...
var file_Discovery_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_Discovery_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_Discovery_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_Discovery_proto_goTypes = []interface{}{
	...
	(TargetLinkInfoDTO_TargetLinkType)(0),               // 6: common_dto.TargetLinkInfoDTO.TargetLinkType
	(*ValidationResponse)(nil),                          // 7: common_dto.ValidationResponse
	(*DiscoveryResponse)(nil),                           // 8: common_dto.DiscoveryResponse
	(*ProbeStageDetails)(nil),                           // 9: common_dto.ProbeStageDetails
	(*CustomAccountDefEntry)(nil),                       // 10: common_dto.CustomAccountDefEntry
	(*AccountDefEntry)(nil),                             // 11: common_dto.AccountDefEntry
	(*ErrorDTO)(nil),                                    // 12: common_dto.ErrorDTO
	(*ErrorTypeInfo)(nil),                               // 13: common_dto.ErrorTypeInfo
	(*CustomMetadataDTO)(nil),                           // 14: common_dto.CustomMetadataDTO
	(*AccountValue)(nil),                                // 15: common_dto.AccountValue
	(*TargetLinkInfoDTO)(nil),                           // 16: common_dto.TargetLinkInfoDTO
	(*DerivedTargetSpecificationDTO)(nil),               // 17: common_dto.DerivedTargetSpecificationDTO
	(*EntityData)(nil),                                  // 18: common_dto.EntityData
	(*DiscoveryContextDTO)(nil),                         // 19: common_dto.DiscoveryContextDTO
	(*NoChange)(nil),                                    // 20: common_dto.NoChange
	(*CustomAccountDefEntry_GroupScopePropertySet)(nil), // 21: common_dto.CustomAccountDefEntry.GroupScopePropertySet
	(*CustomAccountDefEntry_GroupScopeProperty)(nil),    // 22: common_dto.CustomAccountDefEntry.GroupScopeProperty
	(*ErrorTypeInfo_OtherErrorType)(nil),                // 23: common_dto.ErrorTypeInfo.OtherErrorType
	(*ErrorTypeInfo_ConnectionTimeOutErrorType)(nil),    // 24: common_dto.ErrorTypeInfo.ConnectionTimeOutErrorType
	(*ErrorTypeInfo_UnauthenticatedErrorType)(nil),      // 25: common_dto.ErrorTypeInfo.UnauthenticatedErrorType
	(*ErrorTypeInfo_UnauthorizedErrorType)(nil),         // 26: common_dto.ErrorTypeInfo.UnauthorizedErrorType
	(*ErrorTypeInfo_TokenUnavailableErrorType)(nil),     // 27: common_dto.ErrorTypeInfo.TokenUnavailableErrorType
	(*ErrorTypeInfo_TokenExpiredErrorType)(nil),         // 28: common_dto.ErrorTypeInfo.TokenExpiredErrorType
	(*ErrorTypeInfo_DataIsMissingErrorType)(nil),        // 29: common_dto.ErrorTypeInfo.DataIsMissingErrorType
	(*ErrorTypeInfo_VersionNotSupportedErrorType)(nil),  // 30: common_dto.ErrorTypeInfo.VersionNotSupportedErrorType
	(*ErrorTypeInfo_ProbeParsingErrorType)(nil),         // 31: common_dto.ErrorTypeInfo.ProbeParsingErrorType
	(*ErrorTypeInfo_InternalProbeErrorType)(nil),        // 32: common_dto.ErrorTypeInfo.InternalProbeErrorType
	(*ErrorTypeInfo_DuplicationErrorType)(nil),          // 33: common_dto.ErrorTypeInfo.DuplicationErrorType
	(*ErrorTypeInfo_DelayedDataErrorType)(nil),          // 34: common_dto.ErrorTypeInfo.DelayedDataErrorType
	(*ErrorTypeInfo_ThirdPartyApiFailureErrorType)(nil), // 35: common_dto.ErrorTypeInfo.ThirdPartyApiFailureErrorType
	(*AccountValue_PropertyValueList)(nil),              // 36: common_dto.AccountValue.PropertyValueList
	nil,                                                 // 37: common_dto.DiscoveryContextDTO.ContextEntryEntry
	nil,                                                 // 38: common_dto.DiscoveryContextDTO.EntityContextEntryEntry
	(*EntityDTO)(nil),                                   // 39: common_dto.EntityDTO
	(*GroupDTO)(nil),                                    // 40: common_dto.GroupDTO
	(*EntityProfileDTO)(nil),                            // 41: common_dto.EntityProfileDTO
	(*DeploymentProfileDTO)(nil),                        // 42: common_dto.DeploymentProfileDTO
	(*NotificationDTO)(nil),                             // 43: common_dto.NotificationDTO
	(*NonMarketEntityDTO)(nil),                          // 44: common_dto.NonMarketEntityDTO
	(*FlowDTO)(nil),                                     // 45: common_dto.FlowDTO
	(*CostDataDTO)(nil),                                 // 46: common_dto.CostDataDTO
	(*PriceTable)(nil),                                  // 47: common_dto.PriceTable
	(*Workflow)(nil),                                    // 48: common_dto.Workflow
	(*CloudBillingData)(nil),                            // 49: common_dto.CloudBillingData
	(*EntityIdentifyingPropertyValues)(nil),             // 50: common_dto.EntityIdentifyingPropertyValues
	(*CloudCommitmentData)(nil),                         // 51: common_dto.CloudCommitmentData
	(*ActionPolicyDTO)(nil),                             // 52: common_dto.ActionPolicyDTO
	(CustomTypeDef_MetadataNamespace)(0),                // 53: common_dto.CustomTypeDef.MetadataNamespace
	(EntityDTO_EntityType)(0),                           // 54: common_dto.EntityDTO.EntityType
}
var file_Discovery_proto_depIdxs = []int32{
	12, // 0: common_dto.ValidationResponse.errorDTO:type_name -> common_dto.ErrorDTO
	9,  // 1: common_dto.ValidationResponse.stages_detail:type_name -> common_dto.ProbeStageDetails
	12, // 2: common_dto.DiscoveryResponse.errorDTO:type_name -> common_dto.ErrorDTO
	39, // 3: common_dto.DiscoveryResponse.entityDTO:type_name -> common_dto.EntityDTO
	40, // 4: common_dto.DiscoveryResponse.discoveredGroup:type_name -> common_dto.GroupDTO
	41, // 5: common_dto.DiscoveryResponse.entityProfile:type_name -> common_dto.EntityProfileDTO
	42, // 6: common_dto.DiscoveryResponse.deploymentProfile:type_name -> common_dto.DeploymentProfileDTO
	43, // 7: common_dto.DiscoveryResponse.notification:type_name -> common_dto.NotificationDTO
	14, // 8: common_dto.DiscoveryResponse.metadataDTO:type_name -> common_dto.CustomMetadataDTO
	17, // 9: common_dto.DiscoveryResponse.derivedTarget:type_name -> common_dto.DerivedTargetSpecificationDTO
	44, // 10: common_dto.DiscoveryResponse.nonMarketEntityDTO:type_name -> common_dto.NonMarketEntityDTO
	45, // 11: common_dto.DiscoveryResponse.flowDTO:type_name -> common_dto.FlowDTO
	19, // 12: common_dto.DiscoveryResponse.discoveryContext:type_name -> common_dto.DiscoveryContextDTO
	46, // 13: common_dto.DiscoveryResponse.costDTO:type_name -> common_dto.CostDataDTO
	47, // 14: common_dto.DiscoveryResponse.priceTable:type_name -> common_dto.PriceTable
	48, // 15: common_dto.DiscoveryResponse.workflow:type_name -> common_dto.Workflow
	20, // 16: common_dto.DiscoveryResponse.no_change:type_name -> common_dto.NoChange
	9,  // 17: common_dto.DiscoveryResponse.stages_detail:type_name -> common_dto.ProbeStageDetails
	49, // 18: common_dto.DiscoveryResponse.cloudBillingData:type_name -> common_dto.CloudBillingData
	50, // 19: common_dto.DiscoveryResponse.entity_identifying_property_values:type_name -> common_dto.EntityIdentifyingPropertyValues
	51, // 20: common_dto.DiscoveryResponse.cloud_commitment_data:type_name -> common_dto.CloudCommitmentData
	52, // 21: common_dto.DiscoveryResponse.action_policies:type_name -> common_dto.ActionPolicyDTO
	1,  // 22: common_dto.ProbeStageDetails.status:type_name -> common_dto.ProbeStageDetails.StageStatus
	9,  // 23: common_dto.ProbeStageDetails.subStages:type_name -> common_dto.ProbeStageDetails
	2,  // 24: common_dto.CustomAccountDefEntry.primitive_value:type_name -> common_dto.CustomAccountDefEntry.PrimitiveValue
	21, // 25: common_dto.CustomAccountDefEntry.group_scope:type_name -> common_dto.CustomAccountDefEntry.GroupScopePropertySet
	21, // 26: common_dto.CustomAccountDefEntry.entity_scope:type_name -> common_dto.CustomAccountDefEntry.GroupScopePropertySet
	10, // 27: common_dto.AccountDefEntry.custom_definition:type_name -> common_dto.CustomAccountDefEntry
	4,  // 28: common_dto.ErrorDTO.severity:type_name -> common_dto.ErrorDTO.ErrorSeverity
	3,  // 29: common_dto.ErrorDTO.errorType:type_name -> common_dto.ErrorDTO.ErrorType
	13, // 30: common_dto.ErrorDTO.error_Type_Info:type_name -> common_dto.ErrorTypeInfo
	23, // 31: common_dto.ErrorTypeInfo.other_Error_Type:type_name -> common_dto.ErrorTypeInfo.OtherErrorType
	24, // 32: common_dto.ErrorTypeInfo.connection_time_out_error_type:type_name -> common_dto.ErrorTypeInfo.ConnectionTimeOutErrorType
	25, // 33: common_dto.ErrorTypeInfo.unauthenticated_error_type:type_name -> common_dto.ErrorTypeInfo.UnauthenticatedErrorType
	26, // 34: common_dto.ErrorTypeInfo.unauthorized_error_type:type_name -> common_dto.ErrorTypeInfo.UnauthorizedErrorType
	27, // 35: common_dto.ErrorTypeInfo.token_unavailable_error_type:type_name -> common_dto.ErrorTypeInfo.TokenUnavailableErrorType
	28, // 36: common_dto.ErrorTypeInfo.token_expired_error_type:type_name -> common_dto.ErrorTypeInfo.TokenExpiredErrorType
	29, // 37: common_dto.ErrorTypeInfo.data_is_missing_error_type:type_name -> common_dto.ErrorTypeInfo.DataIsMissingErrorType
	30, // 38: common_dto.ErrorTypeInfo.version_not_supported_error_type:type_name -> common_dto.ErrorTypeInfo.VersionNotSupportedErrorType
	31, // 39: common_dto.ErrorTypeInfo.probe_parsing_error_type:type_name -> common_dto.ErrorTypeInfo.ProbeParsingErrorType
	32, // 40: common_dto.ErrorTypeInfo.internal_probe_error_type:type_name -> common_dto.ErrorTypeInfo.InternalProbeErrorType
	33, // 41: common_dto.ErrorTypeInfo.duplication_error_type:type_name -> common_dto.ErrorTypeInfo.DuplicationErrorType
	34, // 42: common_dto.ErrorTypeInfo.delayed_data_error_type:type_name -> common_dto.ErrorTypeInfo.DelayedDataErrorType
	35, // 43: common_dto.ErrorTypeInfo.third_party_api_failure_error_type:type_name -> common_dto.ErrorTypeInfo.ThirdPartyApiFailureErrorType
	53, // 44: common_dto.CustomMetadataDTO.namespace:type_name -> common_dto.CustomTypeDef.MetadataNamespace
	5,  // 45: common_dto.CustomMetadataDTO.dataType:type_name -> common_dto.CustomMetadataDTO.Type
	36, // 46: common_dto.AccountValue.groupScopePropertyValues:type_name -> common_dto.AccountValue.PropertyValueList
	6,  // 47: common_dto.TargetLinkInfoDTO.link_type:type_name -> common_dto.TargetLinkInfoDTO.TargetLinkType
	15, // 48: common_dto.DerivedTargetSpecificationDTO.accountValue:type_name -> common_dto.AccountValue
	16, // 49: common_dto.DerivedTargetSpecificationDTO.target_link_info:type_name -> common_dto.TargetLinkInfoDTO
	37, // 50: common_dto.DiscoveryContextDTO.contextEntry:type_name -> common_dto.DiscoveryContextDTO.ContextEntryEntry
	38, // 51: common_dto.DiscoveryContextDTO.entityContextEntry:type_name -> common_dto.DiscoveryContextDTO.EntityContextEntryEntry
	54, // 52: common_dto.CustomAccountDefEntry.GroupScopePropertySet.entityType:type_name -> common_dto.EntityDTO.EntityType
	22, // 53: common_dto.CustomAccountDefEntry.GroupScopePropertySet.property:type_name -> common_dto.CustomAccountDefEntry.GroupScopeProperty
	18, // 54: common_dto.DiscoveryContextDTO.EntityContextEntryEntry.value:type_name -> common_dto.EntityData
...
func file_Discovery_proto_init() {
	...
	file_CloudCommitment_proto_init()
	if !protoimpl.UnsafeEnabled {
		...
		file_Discovery_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TargetLinkInfoDTO); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_Discovery_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
